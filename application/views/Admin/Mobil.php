            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Data Mobil</h3>
                        </div>
                        <div class="nk-block-head-content">
                                ...
                                <div class="toggle-expand-content" data-content="pageMenu">
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li class="nk-block-tools-opt">
                                            ...
                                            <a href="#" data-target="addProduct" class="toggle btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus"></em><span>Tambah Mobil</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="nk-block">
                    <div class="nk-tb-list is-separate mb-3">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-sm text-center"><span>Nama Mobil</span></div>
                            ...
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-sm">
                                    <span class="tb-product">
                                        ...
                                        <span class="title"><?= $m['nama_mobil'] ?></span>
                                    </span>
                                </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="<?= base_url() ?>Admin/editMobil/<?= $m['id_mobil'] ?>" data-target="editMobil<?= $m['id_mobil'] ?>" class="toggle"><em class="icon ni ni-edit"></em><span>Edit Data Mobil</span></a></li>
                                                        <li><a href="<?= base_url() ?>Admin/getMobil/<?= $m['id_mobil'] ?>" data-toggle="modal" data-target="#modal_mobil<?= $m['id_mobil'] ?>"><em class="icon ni ni-eye"></em><span>View Data Mobil</span></a></li>
                                                        <li><a href="<?= base_url() ?>Admin/deleteMobil/<?= $m['id_mobil'] ?>"><em class="icon ni ni-trash"></em><span>Remove Data Mobil</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </li>
                ...
                <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            <h5 class="nk-block-title">Tambah Data Mobil</h5>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" autocomplete="off" class="form-control" name="nama_mobil" id="nama_mobil" value="<?= set_value('nama_mobil') ?>">
                                            <?= form_error('nama_mobil', '<small class="text-danger pl-3">', '</small>') ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-mb-6">
                                ...
                                <div class="col-mb-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" autocomplete="off" class="form-control" name="kursi" id="kursi" value="<?= set_value('kursi') ?>">
...
<?php foreach ($mobil as $m) : ?>
    <div class="modal fade" id="modal_mobil<?= $m['id_mobil'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Detail Mobil</h5>
...
<?php foreach ($mobil as $m) : ?>
    <div class="nk-add-product toggle-slide toggle-slide-right" data-content="editMobil<?= $m['id_mobil'] ?>" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <label class="form-label" for="nama_mobil">Nama Mobil</label>
                            <div class="form-control-wrap">
                                <input type="text" autocomplete="off" class="form-control" name="nama_mobil" id="nama_mobil" value="<?= $m['nama_mobil'] ?>">
                    ...
                    <div class="col-mb-6">
                        <div class="form-group">
                            <label class="form-label" for="kursi">Kursi</label>
                            <div class="form-control-wrap">
                                <input type="text" autocomplete="off" class="form-control" name="kursi" id="kursi" value="<?= $m['kursi'] ?>">
